...
def main(simulated_time):
    ...
    messages = {"app_1": [{"name": "m_s1", "src": "Sensor1", "dst": "Service1", "instructions": 10000 * 10 ^ 6, "bytes": 5000, "pop": True, "std": None},
                          ...
                          {"name": "m_c1", "src": "Service1", "dst": "Service2", "instructions": 20000 * 10 ^ 6, "bytes": 20000, "pop": False, "std": None},
                          {"name": "m_ack_c2", "src": "Service2", "dst": "Service2", "instructions": 15000 * 10 ^ 6, "bytes": 10000, "pop": False, "std": None},
                          {"name": "m_ack_c3", "src": "Service2", "dst": "Service2", "instructions": 25000 * 10 ^ 6,
                           "bytes": 8000, "pop": False, "std": None},
                          {"name": "m_ack_c1", "src": "Service2", "dst": "Service1", "instructions": 18000 * 10 ^ 6,
                           "bytes": 10000, "pop": False, "std": None},
                          {"name": "m_ack_c4", "src": "Service2", "dst": "Service1", "instructions": 15000 * 10 ^ 6,
                           "bytes": 20000, "pop": False, "std": None},
                          {"name": "m_c2", "src": "Service1", "dst": "Service2", "instructions": 35000 * 10 ^ 6,
                           "bytes": 100000, "pop": False, "std": None},
                          {"name": "m_c3", "src": "Service1", "dst": "Service2", "instructions": 18000 * 10 ^ 6,
                           "bytes": 80000, "pop": False, "std": None},
                          {"name": "m_a3", "src": "Service2", "dst": "Actuator1", "instructions": 2500 * 10 ^ 6,
                           "bytes": 2000, "pop": False, "std": None},
                          {"name": "m_a4", "src": "Service2", "dst": "Actuator1", "instructions": 2500 * 10 ^ 6,
                           "bytes": 2000, "pop": False, "std": None},
    ...
    transmissions = {"app_1": {"Service1": [{"in": "m_s1", "out": "m_c1", "threshold": 1},
                                            ...
                                            {"in": "m_ack_c4", "out": "m_c3", "threshold": 0.5}],
                               "Service2": [{"in": "m_c1", "out": "m_ack_c2", "threshold": 0.01},
                                            {"in": "m_c1", "out": "m_ack_c3", "threshold": 0.01},
                                            {"in": "m_ack_c2", "out": "m_ack_c1", "threshold": 1},
                                            {"in": "m_ack_c3", "out": "m_ack_c4", "threshold": 1},
                                            {"in": "m_s2", "out": "m_ack_s2", "threshold": 1},
                                            {"in": "m_c1", "out": "m_a1", "threshold": 1},
                                            {"in": "m_c2", "out": "m_a3", "threshold": 1},
                                            {"in": "m_c3", "out": "m_a4", "threshold": 1},
