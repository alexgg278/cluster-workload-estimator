...
def main(simulated_time):
    ...
    messages = {"app_1": [{"name": "m_s1", "src": "Sensor1", "dst": "Service1", "instructions": 5000 * 10 ^ 6, "bytes": 1000, "pop": True},
                          {"name": "m_s2", "src": "Sensor2", "dst": "Service2", "instructions": 8000 * 10 ^ 6, "bytes": 1000, "pop": True},
                          {"name": "m_ack_s2", "src": "Service2", "dst": "Sensor2", "instructions": 200 * 10 ^ 6, "bytes": 1000, "pop": False},
                          {"name": "m_c1", "src": "Service1", "dst": "Service2", "instructions": 8000 * 10 ^ 6, "bytes": 1000, "pop": False},
                          {"name": "m_ack_c1", "src": "Service2", "dst": "Service1", "instructions": 200 * 10 ^ 6, "bytes": 1000, "pop": False},
                          {"name": "m_a1", "src": "Service2", "dst": "Actuator1", "instructions": 400 * 10 ^ 6, "bytes": 1000, "pop": False},
                          {"name": "m_a2", "src": "Service2", "dst": "Actuator1", "instructions": 400 * 10 ^ 6, "bytes": 1000, "pop": False}],
                "app_2": [{"name": "m_s1", "src": "Sensor1", "dst": "Service1", "instructions": 6000 * 10 ^ 6, "bytes": 1000, "pop": True},
                          {"name": "m_s2", "src": "Sensor1", "dst": "Service2", "instructions": 6000 * 10 ^ 6, "bytes": 1000, "pop": True},
                          {"name": "m_a1", "src": "Service1", "dst": "Actuator1", "instructions": 1000 * 10 ^ 6, "bytes": 1000, "pop": False},
                          {"name": "m_a2", "src": "Service2", "dst": "Actuator2", "instructions": 1000 * 10 ^ 6, "bytes": 1000, "pop": False}]
                }

    transmissions = {"app_1": {"Service1": [{"in": "m_s1", "out": "m_c1", "threshold": 1}],
                               "Service2": [{"in": "m_c1", "out": "m_ack_c1", "threshold": 1},
    ...
    d_distribution = deterministicDistribution(name="Deterministic", time=50)
