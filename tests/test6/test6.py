"""
1. The goal of this test is to reproduce results of time-series forecasting but by using multivariate data,
that is looking at more than one variable such as the memory usage of other nodes
"""
...
def main(simulated_time):
    ...
    messages = {"app_1": [{"name": "m_s1", "src": "Sensor1", "dst": "Service1", "instructions": 10000 * 10 ^ 6, "bytes": 5000, "pop": True, "std": None},
                          ...
                          {"name": "m_ack_c1", "src": "Service2", "dst": "Service1", "instructions": 18000 * 10 ^ 6,
                           "bytes": 3000, "pop": False, "std": None},
                          {"name": "m_ack_c1_1", "src": "Service1", "dst": "Service1", "instructions": 6000 * 10 ^ 6,
                           "bytes": 7500, "pop": False, "std": None},
    ...
    transmissions = {"app_1": {"Service1": [{"in": "m_s1", "out": "m_c1", "threshold": 1},
                                            {"in": "m_ack_c1", "out": "m_ack_c1_1", "threshold": 1},
                                            {"in": "m_ack_c1_1", "out": "m_c2", "threshold": 1}],
